...
<div id="homeflickr">
<h4><a href="<?php if ( get_option('vubrand_flickrurl') <> "" ) { echo get_option('vubrand_flickrurl'); } else { echo 'http://www.flickr.com/photos/digitalvu/'; } ?>">Our Photos</a></h4>
			<!-- // USE THIS ON SSL SITES
	<script type="text/javascript" src="https://www4.vanderbilt.edu/asset/flickr/secureflickr.js">//</script>
		-->
<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=2&display=random&size=s&layout=x&source=user&user=
<?php if ( get_option('vubrand_flickrid') <> "" ) { echo get_option('vubrand_flickrid'); } else { echo '48007774@N03'; } ?>">"></script>
</div>
