...
if (function_exists('register_sidebar'))
	...
	register_sidebar(array(
		'name' => __( 'Right Sidebar - Bottom', 'vanderbilt brand' ),
		'id' => 'right-bottom-sidebar-widgets',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
...
function brand_login() { 
	echo '<style type="text/css">h1 a { background-image:url('.get_bloginfo('template_directory').'/Vanderbilt-WP.jpg) !important; }';
	echo '</style>'; 
}
...
function brand_admin() {
  echo '<style type="text/css">
    #header-logo { background-image: url('.get_bloginfo('template_directory').'/VanderbiltV.gif) !important; } 
    </style>';
}
...
function brand_login_link(){
	// your URL here
	return "http://web.vanderbilt.edu"; 
}
add_filter('login_headerurl', 'brand_login_link');
...
function mysite_favicon() { ?>
	<link rel="shortcut icon" href="http://www.vanderbilt.edu/favicon.ico" />
<?php }
...
array( "name" => "Overall Site Type",
	"desc" => "Is this primarily a blog or department/organization website?",
	"id" => $shortname."_sitetype",
	"type" => "select",
	"options" => array("Department","Blog"),
	"std" => "Department"),	
...
array( "name" => "Search Method",
	"desc" => "Select the method by which your site will be searched",
	"id" => $shortname."_searchmethod",
	"type" => "select",
	"options" => array("Google Search Appliance", "Wordpress Search"),
	"std" => "Wordpress Search"),		
...
array( "name" => "Pages to Hide in Navigation",
	"desc" => "If using AUTO navigation - you can enter a comma-separated list of ID's that you'd like to exclude from the top navigation. (e.g. 12,23,27,44)",
...
array( "name" => "Header Image",
	...
	"type" => "text",
	"std" => "http://www.vanderbilt.edu/asset/i/Sample-header.jpg"),
...
array( "name" => "Homepage Post Display",
	"desc" => "For BLOG sites -- Show full posts or excerpts only for homepage",
	"id" => $shortname."_homeposts",
	"type" => "select",
	"options" => array("Full", "Excerpts"),
	"std" => "Excerpts"),
...
array( "name" => "Footer and Social Media",
	"type" => "section"),
array( "type" => "open"),

array( "name" => "Show Social Media Share Links",
	"desc" => "Display sharing links at bottom of pages",
...
array( "name" => "Connect / Social Media Section Title",
