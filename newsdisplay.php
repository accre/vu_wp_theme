...
<li><a class="clearfix" href="<?php the_permalink() ?>"><?php if(has_post_thumbnail()) { the_post_thumbnail(array(40,40), array("class" => "left")); } ?><?php the_title(); ?> <small>&raquo;&nbsp;<?php the_time('n.j.y') ?></small></a></li>
<?php endwhile; ?>
</ul>
